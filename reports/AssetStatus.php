...
require_once 'library/functions.php';
	...
	if (isset($_GET['assignid']) && (int)$_GET['assignid'] >= 0) {
	$assignid= (int)$_GET['assignid'];
	$queryString = "&assignid=$assignid";
} else {
	$assignid = 0;
	$queryString = '';
}
...
<?php include_once("include/navigation.php");?><br>
  ...
  <div class="table-responsive-sm">
	...
	<td><?php echo $remarks; ?></td>
	  ...
	  <td> <center><a  style="font-weight:normal;" href="javascript:updateassetstatus(<?php echo $assignid; ?>);">
	  Update</center></a></td>
...
&nbsp;&nbsp;<input name="btnCancel" type="button" id="btnCancel" class="button"  value="Cancel" onClick="window.location.href='index.php?chez=reports/assetsummary.php&tamsSummary';"></input></center>
  </div>
