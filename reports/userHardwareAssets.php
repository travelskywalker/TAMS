...
&nbsp;&nbsp;<input name="btnCancel" type="button" id="btnCancel" class="button"  value="Exit" onClick="window.location.href='index.php?chez=reports/userassetsummary.php&tamsSummary';"></input></center>
  </div>
