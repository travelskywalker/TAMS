...
&nbsp;&nbsp;<input name="btnCancel" type="button" id="btnCancel" class="button"  value="Cancel" onClick="window.location.href='../index.php?chez=rpttrans/MRform.php&tamsMRForm';"></input></center>