...
<?php include_once("include/usernavigation.php");?>
</div>
<p>&nbsp;</p>
...
<form action="process/usersearchhw.php?action=search" method="post" name="frmSearchhwasset" id="frmSearchhwasset">
...
<td> <center>Search mode by:
 ...
 <p align="center"> 
  ...
  &nbsp;&nbsp;<input name="btnCancel" type="button" id="btnCancel" class="btn btn-danger"  value="Cancel" onClick="window.location.href='index.php?chez=usermain.php';">  
 </p>
</fieldset>
