...
<div class="container">
<form action="process/userassetupdate.php?action=update" method="post" name="UpdateAsset" id="UpdateAsset" enctype="multipart/form-data">
   ...
   <td><b>Status</b></td>
	...
	<option value="DISPOSED">DISPOSED</option>
        ...
        <input name="SaveEditAsset" type="submit" class="button" value="Update"> </input> 
		 &nbsp;&nbsp;<input name="btnCancel" type="button" id="btnCancel" class="button"  value="Cancel" onClick="window.location.href='index.php?chez=reports/userAssetStatus.php';">  
 </p>
